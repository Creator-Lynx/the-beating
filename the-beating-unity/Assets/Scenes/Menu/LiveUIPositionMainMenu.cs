...
public class LiveUIPositionMainMenu : MonoBehaviour
{
  
    [SerializeField] Vector2 canvasMaxShiftVector;
    ...
    void Update()
    {
        ...
        targetPos.x = x * canvasMaxShiftVector.x;

        float y = Mouse.current.position.ReadValue().y / Screen.height * 2 - 1;
        targetPos.y = 10 + y * canvasMaxShiftVector.y;
